...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < N_ITERATIONS; i++) {
            ...
            threads[0] = new Reader("elemente1.txt", syncList, S);
            threads[1] = new Reader("elemente2.txt", syncList, S);
            threads[2] = new Reader("elemente3.txt", syncList, S);
            threads[3] = new Sort(list, S);
